...
Raw_input    = squeeze(double(data{3}.Values.Data));
...
yyaxis right
p2 = plot(Time, Scaled_input, 'LineWidth', 1.2); % สัญญาณที่ขยายแล้ว
ylabel('Input Amplitude (Scaled)', 'FontSize', 12, 'FontWeight', 'bold');
